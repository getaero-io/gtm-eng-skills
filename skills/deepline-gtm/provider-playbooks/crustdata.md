...
- Use `crustdata_companydb_search` as the resolver step; for `crustdata_company_enrichment`, prefer stable identifiers (`companyDomain`, `companyLinkedinUrl`, or `companyId`) instead of name-only payloads.
