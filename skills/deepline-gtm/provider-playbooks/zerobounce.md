...
- Use `zerobounce_batch_validate` for bulk verification of 1–100 emails. Play maps automatically batch `zerobounce_validate` calls. Results may take up to 70 seconds; an `unknown` verdict is not a validated email.
