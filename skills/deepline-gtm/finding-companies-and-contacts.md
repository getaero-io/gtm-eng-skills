...
| `crustdata_v2_job_search`                | Indexed job-listing discovery and hiring signals                                                             | company fields, title, location, job metadata                                                                      | dynamic                                     | Use company-domain or company-id filters for known accounts. Coverage is thinner on smaller companies; use `employee_metrics.growth_6m_percent` as a free first-pass hiring proxy when available.                                                                                                                                                                                                |
...
- **`employee_metrics.growth_6m_percent`** is a free hiring proxy already in every search response. Positive 6-month growth suggests active hiring. Use this before spending credits on `crustdata_v2_job_search`, especially for smaller companies where job listing coverage is thin.
