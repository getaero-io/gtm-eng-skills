# Typefully LinkedIn Video Drafts

Created on 2026-06-05 in Typefully social set `Jai Toor` (`299886`).

These are LinkedIn-only drafts with native video attached. The raw Screen Studio exports were too large for Typefully media processing, so the attached MP4s were temporary 1080p compressed uploads created under `/tmp/typefully_sung_videos`.
...
- Status for all three: `draft`.
- LinkedIn platform: enabled.
